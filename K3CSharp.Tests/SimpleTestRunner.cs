    ...
    public class SimpleTestRunner
    {
        ...
        public static void RunAllTests()
        {
            ...
            var tests = new[]
            {
                ...
                ("test_form_symbol.k", "`1"),
                ("test_form_string.k", "\"1\""),
                ("test_form_string_spec.k", "\"42\""),
                ...
                ("test_form_vector_symbol.k", "`1`2`3"),
                ("test_form_braces_vector.k", "1 2 3"),
                ("test_form_braces_mixed.k", "(1;2.5;\"hello\")"),
                ("test_form_braces_nested.k", "(1 2;3 4)"),
