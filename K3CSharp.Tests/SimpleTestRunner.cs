    ...
    public class SimpleTestRunner
    {
        ...
        private static HashSet<string> GetDefinedTestNames()
        {
            ...
            return new HashSet<string>
            {
                ...
                "adverb_scan_max.k", "adverb_scan_power.k", "adverb_scan_with_initialization.k", "adverb_scan_with_initialization_minus.k",
                "adverb_scan_with_initialization_divide.k", "adverb_over_with_initialization_2.k", "adverb_over_with_initialization_1.k",
        ...
        public static void RunAllTests()
        {
            var tests = new[]
            {
                ...
                ("float_exponential_large.k", "1.000000000000000E+015"),  // Large number displays in exponential notation
                ...
                ("adverb_scan_with_initialization_2.k", "3 5 8 12"),
                ("adverb_scan_with_initialization_1.k", "3 6 10 15"),
